...
```bash
nohup python -W ignore Aum_EEB/Aum_EEB_backwards_level3_all.py > Aum_EEB/log_info/level3.log 2>&1 &
nohup python -W ignore Aum_WEB/Aum_WEB_backwards_level3_all.py > Aum_WEB/log_info/level3.log 2>&1 &
nohup python -W ignore Nan_EEB/Nan_EEB_backwards_level3_all.py > Nan_EEB/log_info/level3.log 2>&1 &
nohup python -W ignore Nan_WEB/Nan_WEB_backwards_level3_all.py > Nan_WEB/log_info/level3.log 2>&1 &
